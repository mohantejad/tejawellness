  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-mutedForeground">Browse healthy ingredients.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        <aside className="lg:col-span-4">
          <div className="sticky top-24 rounded-2xl border border-border bg-card p-4 shadow-soft space-y-4">
            ...
            <form className="space-y-3" method="get" action="/ingredients">
              <input
                name="search"
                defaultValue={search}
              ...
              <input
                name="goal"
                defaultValue={goal}
                placeholder="Goal slug (e.g. skin-care)"
        ...
        <section className="lg:col-span-8">
          {items.length === 0 && (
            <div className="text-mutedForeground">No ingredients found.</div>
          )}
